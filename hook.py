...
# שלך token
TOKEN = "eb7d497e-d033-4bc5-a784-5fb51d6b68ba"
    ...
    try:
        ...
        for post in results:
            ...
            filtered_posts.append({
                "user_username_raw": post.get("profile_handle"),
...
def trigger_job():
    try:
        ...
        params = {
            ...
            "endpoint": "https://d93a-41-90-172-146.ngrok-free.app/webhook",  # 🔁 replace if ngrok changes
            "auth_header": TOKEN,
            "format": "json",
